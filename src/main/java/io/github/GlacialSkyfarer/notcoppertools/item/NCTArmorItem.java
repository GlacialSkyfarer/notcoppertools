...
public class NCTArmorItem extends TemplateArmorItem implements ArmorTextureProvider {

    private final String name;

    public NCTArmorItem(Identifier identifier, int durability, int slot, String name) {
