...
public class DoorRecipeBuilder implements IJsonBuilder {

    protected IRecipeIngredient ingredient;
    protected ItemStack result;
    protected String baseName;

    public DoorRecipeBuilder(IRecipeIngredient ingredient, ItemStack result, String baseName) {
        this.ingredient = ingredient;
        this.result = result;
        this.baseName = baseName;
    }
    public DoorRecipeBuilder(IRecipeIngredient ingredient, Item result, String baseName) {
        this.ingredient = ingredient;
        this.result = new ItemStack(result);
        this.baseName = baseName;
    }
    public DoorRecipeBuilder(IRecipeIngredient ingredient, Block result, String baseName) {
        this.ingredient = ingredient;
