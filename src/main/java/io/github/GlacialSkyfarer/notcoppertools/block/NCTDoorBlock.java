...
public class NCTDoorBlock extends TemplateBlock {
    ...
    public NCTDoorBlock(Identifier identifier, Material material) {
    ...
    public NCTDoorBlock setIgnoreHand() {
        this.ignoreHand = true;
        return this;
    }
    public NCTDoorBlock setIgnoreRedstone() {
